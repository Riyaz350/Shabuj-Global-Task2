                ...
                <div className={`${mid? "drawer ": "drawer-open"}`}>
                    ...
                    <div className="drawer-side ">
                        ...
                        <li><h2 >Shabuj Global</h2></li>
                            ...
                            <NavLink className={({ isActive, isPending }) =>isPending ? "pending" : isActive ? active : inActive} to="/dashboard/announcements"><MdOutlineDashboardCustomize className="text-2xl"/>Application History</NavLink>
